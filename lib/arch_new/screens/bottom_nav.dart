...
import 'package:manito/arch_new/screens/posts/post_screen.dart';
...
class _BottomNavState extends ConsumerState<BottomNav>
  ...
  Widget build(BuildContext context) {
    ...
    final friendRequestCount = ref.watch(
      specificBadgeProvider('friend_request'),
    );
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
            icon: customBadgeIconWithLabel(
              badgeState.badgePostCount,
              child: Icon(CustomIcons.flag_filled),
            ),
            label: '',
          ),
          BottomNavigationBarItem(
